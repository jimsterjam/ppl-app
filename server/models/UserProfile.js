...
const userProfileSchema = new mongoose.Schema({
  ...
  // Hinweis: es gab hier zwischenzeitlich ein "personalData"-Unterobjekt (Alter/Geschlecht/
  // Größe/Gewicht als Profilangaben). Zurückgebaut zugunsten einer Körpergewicht-Erfassung PRO
  // Workout (siehe Workout.athleteBodyweightKg) - ein einzelner, gelegentlich aktualisierter
  // Profilwert ergab keine echte Zeitreihe, die sich sinnvoll mit der Kraftentwicklung
  // korrelieren lässt. Absichtlich komplett entfernt statt nur ungenutzt liegengelassen.
}, {
  timestamps: true
})
