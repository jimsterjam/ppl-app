...
export const messages = {
  ...
  exercises: {
    ...
    onboarding: {
      ...
      step2Title: 'So startest du',
      step2Text: 'Erstelle ein Workout oder lasse dir einen Plan erstellen. Wähle die Übungen, die zu deinem Training passen.',
      step3Title: 'Dein Training dokumentieren',
      step3Text: 'Trage nach jedem Satz Wiederholungen und Gewicht ein. Ergänze bei Bedarf eine Notiz, wenn du etwas bewusst anders ausführst oder eine Übung ein besonderes Ziel hat.',
      step4Title: 'KI-Feedback braucht Kontext',
      step4Text: 'Die KI bewertet nur Daten und Hinweise, die vorliegen. Übungsnotizen helfen ihr, dein Training besser einzuordnen und falsche Annahmen zu vermeiden.',
      step5Title: 'Du gestaltest PPL mit',
      step5Text: 'PPL Fundamentals befindet sich in der Testphase. Wenn dir etwas unklar ist, etwas fehlt oder nicht richtig funktioniert, sende uns direkt Feedback. Jede Rückmeldung hilft, die App gezielt zu verbessern.',
      finish: 'PPL entdecken',
      progressLabel: 'Seite {current} von {total}',
      restartTitle: 'Einführungsguide erneut starten',
      restartSubtitle: 'Zeigt die 5-seitige Einführung noch einmal an',
  ...
  ,quickGenFallbackUsed: 'AI is currently unavailable — we created a local workout for you.'
    ...
    onboarding: {
      ...
      step2Title: 'How to get started',
      step2Text: 'Create a workout or have a plan generated for you. Choose the exercises that fit your training.',
      step3Title: 'Log your training',
      step3Text: 'Enter reps and weight after each set. Add a note if you deliberately change how you perform an exercise or if it has a specific goal.',
      step4Title: 'AI feedback needs context',
      step4Text: 'The AI only evaluates the data and notes you provide. Exercise notes help it understand your training better and avoid wrong assumptions.',
      step5Title: 'You help shape PPL',
      step5Text: 'PPL Fundamentals is in its test phase. If anything is unclear, missing, or not working correctly, send us feedback directly. Every message helps improve the app.',
      finish: 'Explore PPL',
      progressLabel: 'Page {current} of {total}',
      restartTitle: 'Restart intro guide',
      restartSubtitle: 'Shows the 5-page introduction again',
