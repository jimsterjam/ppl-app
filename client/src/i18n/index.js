...
export const messages = {
  ...
  exercises: {
    ...
    workoutDetail: {
      ...
      missingNotesDefer: 'Später bewerten',
      missingNotesDeferHint: 'Workout wird ohne KI-Feedback gespeichert. Sobald du Notizen ergänzt hast, kannst du das Feedback im Feedback-Verlauf nachträglich anfordern.',
      editWindowHint: 'Du kannst dieses bereits abgeschlossene Workout noch bis {time} bearbeiten.',
      editWindowExpired: 'Das Bearbeitungsfenster von {hours} Stunden nach Abschluss dieses Workouts ist abgelaufen. Änderungen können nicht mehr gespeichert werden.',
    ...
    postWorkout: {
      ...
      deferredSaved: 'Workout gespeichert - ohne KI-Feedback.',
      deferredHint: 'Sobald du Notizen ergänzt hast, kannst du das Feedback im Feedback-Verlauf nachträglich anfordern.',
      goToFeedbackHistory: 'Zum Feedback-Verlauf',
    ...
    feedbackHistory: {
      ...
      pendingHint: 'Für dieses Workout wurde noch kein KI-Feedback angefordert. Falls du inzwischen Notizen ergänzt hast, kannst du es jetzt generieren.',
      generateNow: 'Jetzt generieren',
      generating: 'Generiere…',
      generateError: 'Feedback konnte gerade nicht generiert werden. Bitte später erneut versuchen.',
      share: 'Teilen',
      ...
      deltaSets: 'Sätze',
      deltaReps: 'Wdh.',
      deltaSetsUnchanged: 'Sätze unverändert',
      deltaRepsUnchanged: 'Wdh. unverändert',
      deltaWeightUnchanged: 'Gewicht unverändert',
  ...
  ,quickGenFallbackUsed: 'AI is currently unavailable — we created a local workout for you.'
    ...
    workoutDetail: {
      ...
      missingNotesDefer: 'Review later',
      missingNotesDeferHint: 'Workout will be saved without AI feedback. Once you\'ve added notes, you can request the feedback later from the feedback history.',
      editWindowHint: 'You can still edit this completed workout until {time}.',
      editWindowExpired: 'The {hours}-hour editing window after completing this workout has expired. Changes can no longer be saved.',
    ...
    postWorkout: {
      ...
      deferredSaved: 'Workout saved - without AI feedback.',
      deferredHint: 'Once you\'ve added notes, you can request the feedback later from the feedback history.',
      goToFeedbackHistory: 'Go to feedback history',
    ...
    feedbackHistory: {
      ...
      pendingHint: 'No AI feedback has been requested for this workout yet. If you\'ve added notes since, you can generate it now.',
      generateNow: 'Generate now',
      generating: 'Generating…',
      generateError: 'Feedback could not be generated right now. Please try again later.',
      share: 'Share',
      ...
      deltaSets: 'sets',
      deltaReps: 'reps',
      deltaSetsUnchanged: 'sets unchanged',
      deltaRepsUnchanged: 'reps unchanged',
      deltaWeightUnchanged: 'weight unchanged',
