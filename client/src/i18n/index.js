...
export const messages = {
  ...
  exercises: {
    ...
    faqs: {
      ...
      statsReadingText: 'Die Fortschrittsvergleiche zeigen jede Übung einzeln mit zwei Kennzahlen:\n\nVolumen-% (oben): Wie viel kg×Wdh insgesamt im Vergleich zur letzten Session. Ein Minus bedeutet nicht automatisch Rückschritt – weniger Sätze mit höherem Gewicht ergeben oft geringeres Gesamtvolumen.\n\nØ-% (darunter): Die Gewichtsänderung pro Satz im Durchschnitt. Ein Plus hier bedeutet: du hast schwerer trainiert. Das ist echter Fortschritt.\n\nDie farbige Markierung links zeigt auf einen Blick was passiert ist:\n│ Grün = höheres Durchschnittsgewicht → Stärker geworden\n│ Blau = mehr Volumen bei gleichem Gewicht → Mehr Volumen\n│ Rot = beides gesunken → Leistung gesunken\n│ Kein Balken = keine relevante Veränderung\n\nDas Badge oben (Gesamt-Workout) fasst zusammen, was überwiegt. Kein Badge bedeutet: alles gleichbleibend.',
  ...
  ,quickGenFallbackUsed: 'AI is currently unavailable — we created a local workout for you.'
    ...
    faqs: {
      ...
      statsReadingText: 'The progress comparisons show each exercise individually with two metrics:\n\nVolume % (top): Total kg×reps compared to your last session. A minus doesn\'t mean regression – fewer sets at higher weight often results in lower total volume.\n\nAvg % (below): The change in average weight per set. A plus here means you lifted heavier. That is real progress.\n\nThe colored bar on the left shows at a glance what happened:\n│ Green = higher average weight → Got stronger\n│ Blue = more volume at same weight → More volume\n│ Red = both declined → Performance dropped\n│ No bar = no significant change\n\nThe badge at the top (whole workout) summarizes what was dominant. No badge means everything stayed the same.',
