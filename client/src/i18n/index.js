...
export const messages = {
  ...
  ,quickGenFallbackUsed: 'AI aktuell nicht erreichbar – wir haben ein lokales Workout für dich erstellt.'
    ...
    settings: {
      ...
      profilePictureChoiceTitle: 'Profilbild',
      profilePictureChoiceEdit: 'Aktuelles Foto bearbeiten',
      profilePictureChoiceReplace: 'Foto austauschen',
      profilePictureEditLoadFailed: 'Aktuelles Foto konnte nicht geladen werden.',
      ...
      german: 'Deutsch',
      english: 'Englisch',
      progressRulesTitle: 'Die 5 Fortschritts-Regeln',
      progressRulesSubtitle: 'Warum manche nie vorankommen - und wie du es besser machst',
      exportDataTitle: 'Meine Daten herunterladen',
      exportDataHint: 'Lädt alle deine gespeicherten Daten (Workouts, Übungen, Favoriten, Feedback) als Datei herunter.',
      exportDataInProgress: 'Wird vorbereitet…',
      exportDataSuccess: 'Deine Daten wurden heruntergeladen.',
      exportDataError: 'Datenexport fehlgeschlagen. Bitte versuch es später erneut.',
  ...
  exercises: {
      ...
      descriptionPlaceholder: 'Kurze Beschreibung oder Ausführungshinweise',
    ...
    workoutDetail: {
      ...
      weightSuggestionInfo: 'Erklärung zum Gewichtsvorschlag',
      noteEdit: 'ändern',
      noteShow: 'anzeigen',
      ...
      bodyweightLabel: 'Körpergewicht heute (optional)',
      bodyweightShort: 'Körpergewicht',
      optionalHint: '(optional)',
      bodyweightHint: 'Freiwillig - hilft dabei, langfristig zu sehen, wie sich dein Körpergewicht und deine Kraft zueinander verhalten.',
    ...
    builder: {
      ...
      created: 'Workout erstellt',
      pushDay: 'Push Day',
      pullDay: 'Pull Day',
      legsDay: 'Leg Day',
      fullBodyDay: 'Ganzkörper',
    ...
    feedbackHistory: {
      ...
      // die beiden anderen Werte gleich geblieben sind (sonst wirkt "20 kg mehr" isoliert und
      // es bleibt unklar, ob auch mehr/weniger Sätze oder Wiederholungen dahinterstecken).
      ...
      // Nachsätze für den Fall, dass GENAU EIN Wert unverändert blieb (die anderen beiden sich
      // aber verändert haben).
    ...
    quickGenerator: {
      ...
      exerciseCountLabel: 'Übungsanzahl',
      exerciseCountAuto: 'Automatisch',
      exerciseCountManual: 'Manuell',
      exerciseCountAutoHint: 'Wird automatisch anhand von Ziel und Trainingsdauer bestimmt.',
      durationManualHint: 'Frei wählbar in 5-Minuten-Schritten.',
      previewDuration: 'Gesamtzeit inkl. Warm-up',
      previewTrainingTime: 'Davon {minutes} min reines Training',
      previewExerciseCount: 'Übungen',
      previewBack: 'Zurück',
      previewConfirm: 'Ins Workout übernehmen',
    ...
    faqs: {
      ...
      progressRules: 'Die 5 Fortschritts-Regeln',
      progressRulesText: 'Die meisten Trainierenden kommen nicht wegen falscher Übungen nicht voran, sondern weil sie zu oft wechseln und zu wenig dokumentieren. Fünf einfache Regeln, mit wissenschaftlichem Hintergrund:\n\n1. Bleib mindestens 6-8 Wochen bei den gleichen Übungen. Studien zufolge werden Trainingsprogramme in der Praxis meist 6-12 Wochen beibehalten - erst über diesen Zeitraum lässt sich beurteilen, ob eine Übung für dich funktioniert. Häufiger, unsystematischer Wechsel (\'Exercise Hopping\') verhindert nachweislich, dass Kraft- und Muskelaufbau-Fortschritte in vergleichbaren Zahlen sichtbar werden.\n\n2. Gleiche Reihenfolge, gleiche Sätze. Nur wenn der Ablauf gleich bleibt, sind deine Zahlen von Woche zu Woche wirklich vergleichbar.\n\n3. Geh in jedem Satz an deine Grenze. Ohne echten Reiz kein Wachstum - ein Satz, der sich leicht anfühlt, bringt dich nicht weiter, auch wenn du ihn geschafft hast.\n\n4. Dokumentiere jeden Satz, jedes Gewicht, jede Wiederholung. Ohne lückenlose Daten kann dir niemand sagen, ob du Fortschritte machst - auch keine KI.\n\n5. Bewerte Fortschritt über Wochen, nicht über eine einzelne Session. Selbst bei stabiler Leistung schwanken Messwerte von Training zu Training um einige Prozent (reine Messungenauigkeit, kein echter Rückschritt). Erst ein Trend über mehrere Wochen ist aussagekräftig.',
      ...
      restPauses: 'Pause zwischen den Sätzen – wie lange?',
      restPausesText: 'Wie lange du zwischen den Sätzen pausierst, beeinflusst, worauf dein Training vor allem einzahlt:\n\nKurze Pausen (ca. 60–90 Sekunden) verlangen eine schnelle Regeneration und erzeugen mehr metabolischen Stress – das begünstigt eher Muskelaufbau (Hypertrophie).\n\nLängere Pausen (ca. 2–4 Minuten, bei sehr schweren Sätzen bis zu 5 Minuten) ermöglichen eine vollständigere Regeneration der Energiebereitstellung (Phosphokreatin-System) – das eignet sich besser für den Aufbau von Maximalkraft, insbesondere bei schweren Grundübungen mit niedrigen Wiederholungszahlen (bis etwa 5 pro Satz).\n\nDiese Einordnung ist allgemeingültig und unabhängig von deinen konkreten Trainingsdaten – die App erfasst deine Pausenzeit aktuell nicht automatisch, du behältst sie am besten selbst im Blick.',
      ...
      weightSuggestion: 'Gewichtsvorschlag: Was bedeuten ↑ und ✓?',
      weightSuggestionText: 'Die App merkt sich, was du bei jeder Übung zuletzt geschafft hast. Hast du beim letzten Mal in allen Sätzen die Ziel-Wiederholungen erreicht (z. B. 5×5 mit 100 kg bei Ziel „Kraft"), zeigt sie im Gewichtsfeld „↑ 102,5": Du bist bereit für etwas mehr Gewicht.\n\nStellst du das Gewicht ein, wird aus dem Pfeil ein ✓. Die App ändert nie selbst etwas. Ob du steigerst, entscheidest du.\n\nHast du nicht alle Sätze geschafft, erscheint kein Vorschlag. Bleib beim Gewicht, bis es klappt. Das Wiederholungsziel richtet sich nach deinem Workout-Ziel (Muskelaufbau oder Kraft) und der Übung.',
    ...
    onboarding: {
      skip: 'Überspringen',
      next: 'Weiter',
      step1Title: 'Willkommen bei PPL Fundamentals',
      step1Text: 'PPL Fundamentals begleitet dich mit einem persönlichen KI-Coach durch dein Training – er bewertet deinen Fortschritt, erkennt Muster und gibt dir gezieltes Feedback, passend zu deinem Ziel, deiner Zeit und deinem Equipment.',
      step2Title: 'So machst du wirklich Fortschritte',
      step2Text: 'Die meisten Trainierenden kommen nicht wegen falscher Übungen nicht voran, sondern weil sie zu oft wechseln und zu wenig dokumentieren. Fünf einfache Regeln helfen dir dabei:',
      rulesItem1: 'Bleib mindestens 6-8 Wochen bei den gleichen Übungen.',
      rulesItem2: 'Gleiche Reihenfolge, gleiche Sätze.',
      rulesItem3: 'Geh in jedem Satz an deine Grenze.',
      rulesItem4: 'Dokumentiere jeden Satz, jedes Gewicht, jede Wiederholung.',
      rulesItem5: 'Bewerte Fortschritt über Wochen, nicht über eine einzelne Session.',
      step3Title: 'So startest du',
      step3Text: 'Erstelle ein Workout oder lasse dir einen Plan erstellen. Wähle die Übungen, die zu deinem Training passen. Auch beim automatisch erstellten Plan hat dein KI-Coach bereits mitgedacht.',
      step4Title: 'Dein Training dokumentieren',
      step4Text: 'Trage nach jedem Satz Wiederholungen und Gewicht ein. Ergänze bei Bedarf eine Notiz, wenn du etwas bewusst anders ausführst oder eine Übung ein besonderes Ziel hat. Diese Angaben sind die Grundlage, mit der dein KI-Coach später dein Training bewertet.',
      step5Title: 'Dein KI-Coach braucht Kontext',
      step5Text: 'Die KI bewertet nur Daten und Hinweise, die vorliegen. Übungsnotizen helfen ihr, dein Training besser einzuordnen und falsche Annahmen zu vermeiden.',
      step6Title: 'Du gestaltest PPL mit',
      step6Text: 'PPL Fundamentals befindet sich in der Testphase. Wenn dir etwas unklar ist, etwas fehlt oder nicht richtig funktioniert, sende uns direkt Feedback. Jede Rückmeldung hilft, die App gezielt zu verbessern.',
      finish: 'PPL entdecken',
      progressLabel: 'Seite {current} von {total}',
      restartTitle: 'Einführungsguide erneut starten',
      restartSubtitle: 'Zeigt die 6-seitige Einführung noch einmal an',
      hintFirstWorkoutTitle: 'Sätze dokumentieren',
      hintFirstWorkoutText: 'Tippe auf Wiederholungen oder Gewicht, um deine Werte einzutragen.',
      hintFirstNoteTitle: 'Notizen geben Kontext',
      hintFirstNoteText: 'Notiere Besonderheiten wie Technikziel, Wiederholungsbereich oder bewusst reduzierte Last. Diese Hinweise helfen bei der späteren KI-Auswertung.',
      hintFirstSaveTitle: 'Dein erstes Workout ist gespeichert',
      hintFirstSaveText: 'War der Ablauf verständlich? Dein Feedback hilft uns, PPL Fundamentals vor dem nächsten Update gezielt zu verbessern.',
      hintFavoritesTitle: 'Was ist ein Favorit?',
      hintFavoritesText: 'Favoriten sind gespeicherte Workout-Vorlagen: Sie merken sich Übungen, Reihenfolge und Zielwerte, damit du ein wiederkehrendes Training nicht jedes Mal neu zusammenstellen musst.',
      hintAiRatingTitle: 'Wie hilfreich war dieses Feedback?',
      hintAiRatingText: 'Mit Daumen hoch oder runter kannst du jede KI-Analyse bewerten. Das ist rein persönlich und freiwillig – es beeinflusst nicht, ob du Feedback bekommst, hilft aber, künftige Analysen passender zu machen.',
      hintGiveFeedback: 'Feedback geben',
      hintLater: 'Später'
    },
    appFeedback: {
      entryTitle: 'Feedback geben',
      entrySubtitle: 'Fehler melden, Ideen vorschlagen oder Unklarheiten mitteilen',
      dialogTitle: 'Feedback geben',
      categoryLabel: 'Worum geht es?',
      categoryBug: 'Fehler melden',
      categoryIdea: 'Idee vorschlagen',
      categoryUnclear: 'Etwas war unklar',
      textPlaceholder: 'Beschreibe kurz, was passiert ist oder was du dir wünschen würdest.',
      consentLabel: 'App-Version, Betriebssystem, Gerätemodell und aktuellen App-Bereich mitsenden',
      consentHint: 'Deine Trainingsdaten, Übungsnotizen und KI-Feedback-Inhalte werden nie automatisch mitgesendet.',
      submit: 'Absenden',
  ...
  ,quickGenFallbackUsed: 'AI is currently unavailable — we created a local workout for you.'
    ...
    settings: {
      ...
      profilePictureChoiceTitle: 'Profile picture',
      profilePictureChoiceEdit: 'Edit current photo',
      profilePictureChoiceReplace: 'Replace photo',
      profilePictureEditLoadFailed: 'Could not load the current photo.',
      app: 'App Settings',
      username: 'Username',
      ...
      german: 'German',
      english: 'English',
      progressRulesTitle: 'The 5 progress rules',
      progressRulesSubtitle: "Why some people never move forward - and how to do it right",
      exportDataTitle: 'Download my data',
      exportDataHint: 'Download all your saved data (workouts, exercises, favorites, feedback) as a file.',
      exportDataInProgress: 'Preparing…',
      exportDataSuccess: 'Your data has been downloaded.',
      exportDataError: 'Data export failed. Please try again later.',
      legalTitle: 'ℹ️ Legal',
    ...
    exercises: {
      ...
      descriptionPlaceholder: 'Short description or execution tips',
    ...
    workoutDetail: {
      ...
      weightSuggestionInfo: 'About the weight suggestion',
      noteEdit: 'edit',
      noteShow: 'show',
      noteAdd: 'Add note',
      noteDelete: 'delete',
      ...
      bodyweightLabel: 'Bodyweight today (optional)',
      bodyweightShort: 'Body weight',
      optionalHint: '(optional)',
      bodyweightHint: 'Optional - helps you see over time how your bodyweight and strength relate to each other.',
    ...
    feedbackHistory: {
      ...
      deltaSuffixRepsChanged: 'with the same number of sets and the same weight',
      deltaSuffixSetsChanged: 'with the same weight and number of reps',
      deltaSuffixOnlyWeightUnchanged: 'with the same weight',
      deltaSuffixOnlyRepsUnchanged: 'with the same number of reps',
      deltaSuffixOnlySetsUnchanged: 'with the same number of sets',
      deltaImprovement: 'a clear improvement',
      deltaAnd: 'and',
    ...
    quickGenerator: {
      ...
      exerciseCountAuto: 'Automatic',
      exerciseCountManual: 'Manual',
      exerciseCountAutoHint: 'Determined automatically based on goal and session length.',
      durationManualHint: 'Freely adjustable in 5-minute steps.',
      previewDuration: 'Total time incl. warm-up',
      previewTrainingTime: 'Of which {minutes} min pure training',
      previewExerciseCount: 'Exercises',
      previewBack: 'Back',
      previewConfirm: 'Use this workout',
    ...
    faqs: {
      ...
      progressRules: 'The 5 progress rules',
      progressRulesText: "Most people don't stall because of the wrong exercises - they stall because they switch too often and log too little. Five simple rules, with the science behind them:\n\n1. Stick with the same exercises for at least 6-8 weeks. Research-based programs are typically kept for 6-12 weeks - only over that timeframe can you actually tell whether an exercise works for you. Frequent, unsystematic changes ('exercise hopping') have been shown to hold back strength and hypertrophy gains, because progress never shows up in comparable numbers.\n\n2. Same order, same sets. Your numbers are only comparable week to week if the routine stays the same.\n\n3. Push close to your limit on every set. No real stimulus, no growth - a set that feels easy won't move you forward, even if you completed it.\n\n4. Log every set, every weight, every rep. Without complete data, nobody - not even an AI - can tell you whether you're actually progressing.\n\n5. Judge progress over weeks, not a single session. Even with stable performance, measurements naturally vary a few percent session to session (pure measurement noise, not a real setback). Only a trend across several weeks is meaningful.",
      ...
      restPauses: 'Rest between sets – how long?',
      restPausesText: "How long you rest between sets shapes what your training mostly pays into:\n\nShort rests (roughly 60–90 seconds) demand quick recovery and create more metabolic stress — that favors muscle growth (hypertrophy).\n\nLonger rests (roughly 2–4 minutes, up to 5 minutes for very heavy sets) allow fuller recovery of your energy system (the phosphocreatine system) — that suits building maximal strength better, especially for heavy compound lifts with low rep counts (up to about 5 per set).\n\nThis guidance is general and independent of your specific training data — the app doesn't currently track your rest time automatically, so keep an eye on it yourself.",
      ...
      weightSuggestion: 'Weight suggestion: what do ↑ and ✓ mean?',
      weightSuggestionText: 'The app remembers what you achieved for each exercise last time. If you hit the target reps in every set (e.g. 5×5 at 100 kg with goal "Strength"), the weight field shows "↑ 102.5": you\'re ready for a bit more weight.\n\nOnce you set that weight, the arrow turns into a ✓. The app never changes anything by itself. Whether you increase is up to you.\n\nIf you didn\'t complete all sets, no suggestion appears. Stay at that weight until you do. The rep target depends on your workout goal (muscle building or strength) and the exercise.',
    ...
    onboarding: {
      skip: 'Skip',
      next: 'Next',
      step1Title: 'Welcome to PPL Fundamentals',
      step1Text: 'PPL Fundamentals comes with a personal AI coach that guides your training – reviewing your progress, spotting patterns, and giving you targeted feedback, matched to your goal, your time and your equipment.',
      step2Title: 'How you actually make progress',
      step2Text: "Most people don't stall because of the wrong exercises - they stall because they switch too often and log too little. Five simple rules help with that:",
      rulesItem1: 'Stick with the same exercises for at least 6-8 weeks.',
      rulesItem2: 'Same order, same sets.',
      rulesItem3: 'Push close to your limit on every set.',
      rulesItem4: 'Log every set, every weight, every rep.',
      rulesItem5: 'Judge progress over weeks, not a single session.',
      step3Title: 'How to get started',
      step3Text: "Create a workout or have a plan generated for you. Choose the exercises that fit your training. Even the auto-generated plan already has your AI coach's input.",
      step4Title: 'Log your training',
      step4Text: 'Enter reps and weight after each set. Add a note if you deliberately change how you perform an exercise or if it has a specific goal. These entries are what your AI coach later uses to evaluate your training.',
      step5Title: 'Your AI coach needs context',
      step5Text: 'The AI only evaluates the data and notes you provide. Exercise notes help it understand your training better and avoid wrong assumptions.',
      step6Title: 'You help shape PPL',
      step6Text: 'PPL Fundamentals is in its test phase. If anything is unclear, missing, or not working correctly, send us feedback directly. Every message helps improve the app.',
      finish: 'Explore PPL',
      progressLabel: 'Page {current} of {total}',
      restartTitle: 'Restart intro guide',
      restartSubtitle: 'Shows the 6-page introduction again',
      hintFirstWorkoutTitle: 'Log your sets',
      hintFirstWorkoutText: 'Tap reps or weight to enter your values.',
      hintFirstNoteTitle: 'Notes add context',
      hintFirstNoteText: 'Note special details like a technique goal, rep range, or intentionally reduced load. These help with later AI analysis.',
      hintFirstSaveTitle: 'Your first workout is saved',
      hintFirstSaveText: 'Was the process clear? Your feedback helps us improve PPL Fundamentals before the next update.',
      hintFavoritesTitle: 'What is a favorite?',
      hintFavoritesText: 'Favorites are saved workout templates: they remember exercises, order, and target values so you don\'t have to rebuild a recurring workout from scratch every time.',
      hintAiRatingTitle: 'How helpful was this feedback?',
      hintAiRatingText: 'Use thumbs up or down to rate any AI analysis. This is purely personal and optional - it doesn\'t affect whether you get feedback, but helps make future analyses more relevant.',
      hintGiveFeedback: 'Give feedback',
      hintLater: 'Later'
    },
    appFeedback: {
      entryTitle: 'Give feedback',
      entrySubtitle: 'Report a bug, suggest an idea, or share what was unclear',
      dialogTitle: 'Give feedback',
      categoryLabel: 'What is this about?',
      categoryBug: 'Report a bug',
      categoryIdea: 'Suggest an idea',
      categoryUnclear: 'Something was unclear',
      textPlaceholder: 'Briefly describe what happened or what you would like to see.',
      consentLabel: 'Include app version, OS, device model and current app area',
      consentHint: 'Your training data, exercise notes and AI feedback content are never sent automatically.',
      submit: 'Submit',
      submitting: 'Sending…',
