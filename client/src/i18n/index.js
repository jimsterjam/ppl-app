...
export const messages = {
  ...
  exercises: {
    ...
    workoutDetail: {
      ...
      alreadyCompletedBlocked: 'Dieses Workout ist bereits abgeschlossen und kann nicht mehr bearbeitet werden.',
  ...
  ,quickGenFallbackUsed: 'AI is currently unavailable — we created a local workout for you.'
    ...
    workoutDetail: {
      ...
      alreadyCompletedBlocked: 'This workout is already completed and can no longer be edited.',
