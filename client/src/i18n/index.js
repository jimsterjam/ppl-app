...
export const messages = {
  ...
  ,quickGenFallbackUsed: 'AI aktuell nicht erreichbar – wir haben ein lokales Workout für dich erstellt.'
    ...
    settings: {
      ...
      personalDataTitle: 'Persönliche Angaben (freiwillig)',
    ...
    personalData: {
      hint: 'Komplett freiwillig - kann das KI-Feedback etwas passgenauer machen, hat aber keinerlei Einfluss darauf, ob du die App nutzen kannst.',
      age: 'Alter',
  ...
  exercises: {
    ...
    onboarding: {
      ...
      step7Title: 'Noch ein paar freiwillige Angaben',
      step7Text: 'Alter, Geschlecht, Größe und Gewicht können dein KI-Feedback etwas passgenauer machen. Komplett freiwillig - du kannst jederzeit in den Einstellungen etwas ändern oder leer lassen.',
  ...
  ,quickGenFallbackUsed: 'AI is currently unavailable — we created a local workout for you.'
    ...
    settings: {
      ...
      personalDataTitle: 'Personal details (optional)',
    ...
    personalData: {
      hint: 'Completely optional - can make your AI feedback a bit more accurate, but has no effect on whether you can use the app.',
      age: 'Age',
    ...
    onboarding: {
      ...
      step7Title: 'A few optional details',
      step7Text: 'Age, gender, height and weight can make your AI feedback a bit more accurate. Completely optional - you can change or clear this anytime in Settings.',
      finish: 'Explore PPL',
