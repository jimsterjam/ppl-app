<template>
  <div class="settings-view">
    ...
    <div class="settings-content">
      ...
      <!-- Profilbild und Benutzername werden jetzt direkt im Dashboard bearbeitet (Klick auf
           Avatar bzw. Namen im Header, siehe AvatarEditor.vue/NameEditModal.vue in
           DashboardView.vue) - hier bewusst entfernt, um Settings aufzuräumen (User-Feedback:
           "so könnte man den Bereich Einstellungen aufräumen, weil dort Profilfoto und
           Profilname nicht mehr benötigt werden würden"). -->
...
// Profilbild und Benutzername werden jetzt direkt im Dashboard bearbeitet (siehe
// components/AvatarEditor.vue, components/NameEditModal.vue, DashboardView.vue) - die komplette
// bisherige Avatar-/Crop-/Username-Logik wurde von hier dorthin verschoben, nicht dupliziert.
